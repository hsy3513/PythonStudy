...
'''
    ...
    승 ) 사용자: 가위, 컴퓨터: 보 / 사용자: 바위, 컴퓨터: 가위 / 사용자: 보, 컴퓨터: 바위
    ...
    * import random 추가해야 함!
    ...
    random.randint(start, end): start 이상 end 미만의 정수(Random 유사)
    random.choice(시퀸스): 시퀸스(리스트, 문자열 등)에서 임의의 요소(데이터) 선택
'''
